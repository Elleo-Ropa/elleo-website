      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-24">
          {STATS.map((stat, index) => (
            ...
            >
              ...
              <div className="font-serif text-6xl lg:text-7xl text-white mb-4 flex items-center drop-shadow-2xl group-hover:scale-110 transition-transform duration-500 origin-center">
        ...
        >
          ...
          <div className="relative border border-white/10 bg-white/5 backdrop-blur-md rounded-3xl p-8 md:p-12 flex flex-col items-center mt-32">
            ...
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-elleo-dark border border-elleo-light text-elleo-light px-6 py-2 rounded-full text-[0.8rem] font-bold uppercase tracking-widest z-10">
              Branch Distribution
            </div>

            <div className="flex flex-wrap justify-around items-center gap-8 md:gap-16 w-full pt-2">
              <div className="flex flex-col items-center group">
                <b className="text-white text-4xl md:text-5xl font-serif mb-2 group-hover:text-elleo-light transition-colors">
                  <Counter value="25" />
                </b>
