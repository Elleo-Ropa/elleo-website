...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[100vh] bg-black overflow-hidden flex flex-col justify-end pb-36 md:pb-[25vh] lg:pb-16">
      {/* 
      ...
      */}
      ...
      <div className="relative z-20 w-full container mx-auto pl-6 pr-3 md:px-6 flex flex-row items-end justify-between">
        ...
        >
          ...
          <h1 className="font-serif text-2xl md:text-[26px] lg:text-[43px] text-white tracking-tight max-w-[800px] drop-shadow-2xl">
