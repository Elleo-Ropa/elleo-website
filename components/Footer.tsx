    ...
    <footer id="contact" className="bg-[#ede9fe] pt-10">
      ...
      */}
      <div className="container mx-auto px-6">
        ...
        <div className="w-full bg-elleo-dark text-white rounded-t-[3rem] pt-20 pb-[1.5rem] overflow-hidden shadow-2xl relative px-6 md:px-12 lg:px-20">
          <div className="relative z-10">

            {/* Main Footer Content: Logo - Info Columns - Symbol */}
            {/* Updated gap from lg:gap-20 to lg:gap-[10rem] as requested */}
            <div className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-[7rem] mb-[5rem]">
              ...
              <div className="flex-grow grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 font-sans">
