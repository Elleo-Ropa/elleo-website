  ...
  return (
    ...
    <section className="pt-40 pb-24 bg-white overflow-hidden relative">
      <div className="container mx-auto px-6">
        ...
        <div className="relative w-full rounded-[3rem] overflow-hidden min-h-[700px] flex items-center bg-gradient-to-br from-white via-[#f5f3ff] to-[#ede9fe]">
          ...
          <div className="relative z-10 w-full py-20 px-8 md:px-16 lg:px-24 flex flex-col lg:flex-row gap-0 items-center">
            ...
            <div className="lg:w-1/2">
              ...
              >
                ...
                <h2 className="font-serif text-5xl md:text-6xl lg:text-[3.5rem] text-elleo-dark leading-[1.1] md:leading-[1.1] lg:leading-[1.1] mb-[1rem] tracking-tighter">
                ...
                <div className="relative">
                  ...
                  <p className="font-sans text-[1.1rem] text-elleo-dark/80 leading-relaxed max-w-[50rem]">
                    To be number 1 destination for quick sushi experience <br />
